const global = { 
    ...
    api: {
        apiKey: 'a2225e2206b99cf35d493ea7615b70c6',
        ...
        results.forEach((show) => {
            ...
            div.innerHTML = `
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">
                        <small class="text-muted">Last Air Date: ${show.last_air_date}</small>
                    </p>
                </div>
            `;
...
async function displayShowDetails() {
   ...
   <div class="details-top">
        ...
        <div class="details-bottom">
          <h2>Show Info</h2>
          <ul>  
            <li><span class="text-secondary">Nummber of Episodes </span> ${show.number_of_episodes}</li>
...
// Create & Display Pagination for Pagination
function displayPagination() {
    ...
    <div class="page-counter">Page ${global.search.page} of ${global.
    search.totalPages}</div>
    `;
...
async function fetchAPIData(endpoint) {
    // Regaister key at https//www.themoviedb.org/setttings/api 
    // and enter here
    // Only use this for development or very small projects, You should 
    // store your key and make requests from the server 
